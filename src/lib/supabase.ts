  ...
  public: {
    Tables: {
      ...
      bot_users: {
        ...
        Insert: Omit<Database['public']['Tables']['bot_users']['Row'], 'id' | 'created_at' | 'updated_at'>;
      ...
      broadcast_jobs: {
        ...
        Insert: Omit<Database['public']['Tables']['broadcast_jobs']['Row'], 'id' | 'created_at'>;
        Update: Partial<Database['public']['Tables']['broadcast_jobs']['Insert']>;
      };
      broadcast_failures: {
        Row: {
          id: string;
        ...
        Insert: Omit<Database['public']['Tables']['broadcast_failures']['Row'], 'id' | 'created_at'>;
        Update: Partial<Database['public']['Tables']['broadcast_failures']['Insert']>;
      };
      messages: {
        Row: {
          id: string;
