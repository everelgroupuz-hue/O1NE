        ...
        <main className="max-w-lg mx-auto px-4 py-6 space-y-3">
          ...
          {faqData.map((item, i) => (
            ...
            >
              ...
              >
                <div className="w-9 h-9 rounded-xl bg-surface-muted flex items-center justify-center flex-shrink-0">
              ...
              {openIndex === i && (
                <div className="px-4 pb-4 -mt-1">
                  <div className="pl-12 text-sm text-text-secondary leading-relaxed">
